...
func run_bee() {
	parametros := "API_FORMS_MANAGEMENT_HTTP_PORT=" + beego.AppConfig.String("httpport") + " FORMS_MANAGEMENT_CRUD__PGUSER=" + beego.AppConfig.String("PGuser") + " FORMS_MANAGEMENT_CRUD__PGPASS=" + beego.AppConfig.String("PGpass") + " FORMS_MANAGEMENT_CRUD__PGURLS=" + beego.AppConfig.String("PGurls") + " FORMS_MANAGEMENT_CRUD__PGDB=" + beego.AppConfig.String("PGdb") + " FORMS_MANAGEMENT_CRUD__SCHEMA=" + beego.AppConfig.String("PGschemas") + " bee run"
